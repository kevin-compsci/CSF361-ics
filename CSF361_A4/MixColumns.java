/* 
MixColumns algorithm provided by Dr. Young for CS361f; credit goes to Dr. Young for the algorithm.
Modified by Kevin Nguyen fpr assignment 4, AES 2016.
*/
...
public class MixColumns {
    ...
    public int[][] mixColumn2 (int c, int[][] st) {
    ...
    public int[][] invMixColumn2 (int c, int[][] st) {
		int a[] = new int[4];
